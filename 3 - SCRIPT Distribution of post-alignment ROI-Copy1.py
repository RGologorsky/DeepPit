...
def idxs2csc_bbox(input_idx, atlas_idx, pad_amts):
    ...
    imax, jmax, kmax = [min(x+pad, shape) for x,pad,shape in zip(maxs, max_pads, input_arr.shape)]
    ...
    return {"input_idx": input_idx, "atlas_idx": atlas_idx,             "align0": align0_dice, "align1": align1_dice, "csc": csc,             **pad_dict, **bbox2diff(csc_gt_bbox, csc_pred_bbox)}
